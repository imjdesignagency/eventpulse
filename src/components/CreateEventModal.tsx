      ...
      <div className="relative bg-[#111111] text-[#E0E0E0] w-full max-w-3xl rounded-3xl shadow-2xl border border-[#2A2A2A] overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6 flex-1 text-xs sm:text-sm bg-[#111111]">
          ...
          <div className="space-y-4">
            ...
            {/* Banner Presets */}
            <div>
              <label className="block font-semibold text-[#CCCCCC] mb-2">Event Cover Banner</label>
              ...
              <input
                ...
                className="mt-2 w-full px-3 py-2 rounded-xl bg-[#181818] border border-[#2E2E2E] text-white text-xs placeholder-[#555555] focus:border-[#D4AF37] focus:outline-none"
              />
            </div>
          </div>
